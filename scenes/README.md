# Device-scale reference scenes

The `.xreate.json` projects directly in this folder are human-authored learning
exercises and reference scenes. They are kept at device scale for AR/XR review.
...
Some examples use supplied image textures. Those images are workflow inputs,
not a claim of human graphic authorship: they deliberately model a developer
who can build in 3D but works with graphics supplied by others. See
[`assets/ATTRIBUTION.md`](../assets/ATTRIBUTION.md) for asset credits.

The [`cinematic-experimental/`](cinematic-experimental/) subfolder is separate:
its large-scale spatial studies are AI-generated and may not meet the
device-scale performance contract of this folder.
